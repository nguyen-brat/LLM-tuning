...
ACCELERATE_PATH="/home/nguyen/code/llm-tune/custom_train/src/config/accelerate_config.yaml"
...
accelerate launch --config_file $ACCELERATE_PATH /home/nguyen/code/llm-tune/custom_train/dev/fine_tune_dev.py \
    ${TRAINING_ARGS[@]} \
    ${DATA_ARGS[@]} \
    ${EVAL_AND_LOGGING_ARGS[@]}